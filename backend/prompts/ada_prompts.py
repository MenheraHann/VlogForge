...
# v7: 三图体系 — 缩略图
ADA_ITEM_THUMBNAIL_PROMPT = """请根据以下产品信息生成一张产品缩略图：
...
# v7: 三图体系 — 三视图（正面/侧面/背面）
ADA_ITEM_THREE_VIEW_PROMPT = """请根据以下产品信息生成一张产品三视图：
...
- 背景纯白，光线均匀
- 展示产品的外形、尺寸、标签等细节
- 适合让视频制作 AI 理解产品的完整外观
"""

# v7: 三图体系 — 功能介绍图
ADA_ITEM_FEATURE_PROMPT = """请根据以下产品信息生成一张产品功能介绍图：
